...
<div class="flex flex-col justify-end h-full p-4 pt-0">
  ...
  <form on:submit|preventDefault={postMessage} class="flex flex-row w-full gap-2 flex-nowrap">
    ...
    <input
      ...
      name="username"
      id="usernameInput"
      class="p-4 py-2 border-2 border-transparent rounded-lg outline-none bg-zinc-300 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-800 dark:placeholder:text-zinc-400 focus:border-cyan-500 dark:focus:border-cyan-400"
    ...
    <input
      ...
      name="message"
      id="messageInput"
      class="w-full p-4 py-2 border-2 border-transparent rounded-lg outline-none bg-zinc-300 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-800 dark:placeholder:text-zinc-400 focus:border-cyan-500 dark:focus:border-cyan-400"
